...
* modification: the equation name "yield" has been replaced with
* "yield_" to avoid using Python keyword
...
Equation
   yield_   'alkylate yield definition'
...
yield_..   alkylate =e= olefin*(1.12+.13167*ratio-.00667*sqr(ratio));
...
Model
   process 'process model with equalities'
           / yield_, makeup, sdef, motor, drat, ddil, df4, dprofit /
